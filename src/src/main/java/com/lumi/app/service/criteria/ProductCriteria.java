...
/**
 * Criteria class for the {@link com.lumi.app.domain.Product} entity. This class is used
 * in {@link com.lumi.app.web.rest.ProductResource} to receive all the possible filtering options from
...
public class ProductCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, code, name, slug, status, createdAt, updatedAt, distinct);
    }
