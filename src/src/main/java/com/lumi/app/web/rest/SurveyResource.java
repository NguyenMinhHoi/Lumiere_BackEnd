...
/**
 * REST controller for managing {@link com.lumi.app.domain.Survey}.
 */
@RestController
...
public class SurveyResource {
    ...
    /**
     * {@code SEARCH  /surveys/_search?query=:query} : search for the survey corresponding
     * to the query.
     *
     ...
     */
    @GetMapping("/_search")
    public ResponseEntity<List<SurveyDTO>> searchSurveys(
