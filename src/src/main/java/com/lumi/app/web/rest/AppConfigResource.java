...
/**
 * REST controller for managing {@link com.lumi.app.domain.AppConfig}.
 */
@RestController
...
public class AppConfigResource {
    ...
    /**
     * {@code SEARCH  /app-configs/_search?query=:query} : search for the appConfig corresponding
     * to the query.
     *
     ...
     */
    @GetMapping("/_search")
    public List<AppConfigDTO> searchAppConfigs(@RequestParam("query") String query) {
