  ...
  return (
    <div>
      <h2 id="customer-heading" data-cy="CustomerHeading">
        <Translate contentKey="lumiApp.customer.home.title">Customers</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="lumiApp.customer.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/customer/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="lumiApp.customer.home.createLabel">Create new Customer</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('lumiApp.customer.home.search')}
                />
        ...
        {customerList && customerList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="lumiApp.customer.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="lumiApp.customer.code">Code</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('code')} />
                </th>
                ...
                <th className="hand" onClick={sort('tier')}>
                  <Translate contentKey="lumiApp.customer.tier">Tier</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('tier')} />
                </th>
                ...
                <th className="hand" onClick={sort('dob')}>
                  <Translate contentKey="lumiApp.customer.dob">Dob</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('dob')} />
                </th>
            ...
            <tbody>
              {customerList.map((customer, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`lumiApp.CustomerTier.${customer.tier}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="lumiApp.customer.home.notFound">No Customers found</Translate>
            </div>
          )
        )}
      </div>
