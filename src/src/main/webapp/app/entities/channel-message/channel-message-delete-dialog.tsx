...
import { deleteEntity, getEntity } from './channel-message.reducer';
...
export const ChannelMessageDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/channel-message${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="lumiApp.channelMessage.delete.question">
        <Translate contentKey="lumiApp.channelMessage.delete.question" interpolate={{ id: channelMessageEntity.id }}>
