...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTEGRATIONLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_INTEGRATIONLOGS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INTEGRATIONLOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INTEGRATIONLOG actions', async () => {
      const arg = { id: 19675 };
    ...
    it('dispatches UPDATE_INTEGRATIONLOG actions', async () => {
      const arg = { id: 19675 };
    ...
    it('dispatches PARTIAL_UPDATE_INTEGRATIONLOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INTEGRATIONLOG actions', async () => {
      const arg = 42666;
