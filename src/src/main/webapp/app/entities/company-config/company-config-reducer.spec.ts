...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPANYCONFIG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_COMPANYCONFIGS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMPANYCONFIG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMPANYCONFIG actions', async () => {
      const arg = { id: 15379 };
    ...
    it('dispatches UPDATE_COMPANYCONFIG actions', async () => {
      const arg = { id: 15379 };
    ...
    it('dispatches PARTIAL_UPDATE_COMPANYCONFIG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMPANYCONFIG actions', async () => {
      const arg = 42666;
