...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKETFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_TICKETFILES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TICKETFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TICKETFILE actions', async () => {
      const arg = { id: 17716 };
    ...
    it('dispatches UPDATE_TICKETFILE actions', async () => {
      const arg = { id: 17716 };
    ...
    it('dispatches PARTIAL_UPDATE_TICKETFILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TICKETFILE actions', async () => {
      const arg = 42666;
