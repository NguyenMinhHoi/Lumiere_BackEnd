...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SURVEYRESPONSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SURVEYRESPONSES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SURVEYRESPONSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SURVEYRESPONSE actions', async () => {
      const arg = { id: 14054 };
    ...
    it('dispatches UPDATE_SURVEYRESPONSE actions', async () => {
      const arg = { id: 14054 };
    ...
    it('dispatches PARTIAL_UPDATE_SURVEYRESPONSE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SURVEYRESPONSE actions', async () => {
      const arg = 42666;
