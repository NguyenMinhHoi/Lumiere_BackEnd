...
import { getEntities, searchEntities } from './app-config.reducer';
  ...
  return (
    <div>
      <h2 id="app-config-heading" data-cy="AppConfigHeading">
        <Translate contentKey="lumiApp.appConfig.home.title">App Configs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="lumiApp.appConfig.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/app-config/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="lumiApp.appConfig.home.createLabel">Create new App Config</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('lumiApp.appConfig.home.search')}
                />
        ...
        {appConfigList && appConfigList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="lumiApp.appConfig.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('appCode')}>
                  <Translate contentKey="lumiApp.appConfig.appCode">App Code</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('appCode')} />
                </th>
                <th className="hand" onClick={sort('configKey')}>
                  <Translate contentKey="lumiApp.appConfig.configKey">Config Key</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('configKey')} />
                </th>
                <th className="hand" onClick={sort('configValue')}>
                  <Translate contentKey="lumiApp.appConfig.configValue">Config Value</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('configValue')} />
                </th>
                <th className="hand" onClick={sort('createdAt')}>
                  <Translate contentKey="lumiApp.appConfig.createdAt">Created At</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('createdAt')} />
                </th>
                <th className="hand" onClick={sort('updatedAt')}>
                  <Translate contentKey="lumiApp.appConfig.updatedAt">Updated At</Translate>{' '}
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/app-config/${appConfig.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="lumiApp.appConfig.home.notFound">No App Configs found</Translate>
            </div>
          )
        )}
      </div>
