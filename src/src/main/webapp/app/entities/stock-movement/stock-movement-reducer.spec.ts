...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOCKMOVEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_STOCKMOVEMENTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STOCKMOVEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STOCKMOVEMENT actions', async () => {
      const arg = { id: 1833 };
    ...
    it('dispatches UPDATE_STOCKMOVEMENT actions', async () => {
      const arg = { id: 1833 };
    ...
    it('dispatches PARTIAL_UPDATE_STOCKMOVEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STOCKMOVEMENT actions', async () => {
      const arg = 42666;
