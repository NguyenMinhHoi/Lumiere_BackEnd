...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUDITHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_AUDITHISTORIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AUDITHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AUDITHISTORY actions', async () => {
      const arg = { id: 28908 };
    ...
    it('dispatches UPDATE_AUDITHISTORY actions', async () => {
      const arg = { id: 28908 };
    ...
    it('dispatches PARTIAL_UPDATE_AUDITHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AUDITHISTORY actions', async () => {
      const arg = 42666;
