...
public class OrdersTestSamples {
    ...
    public static Orders getOrdersSample1() {
        return new Orders().id(1L).customerId(1L).code("code1").currency("currency1").note("note1");
    }

    public static Orders getOrdersSample2() {
        return new Orders().id(2L).customerId(2L).code("code2").currency("currency2").note("note2");
    }
