...
public class SurveyQuestionTestSamples {
    ...
    public static SurveyQuestion getSurveyQuestionSample1() {
        return new SurveyQuestion().id(1L).surveyId(1L).text("text1").scaleMin(1).scaleMax(1).orderNo(1);
    }

    public static SurveyQuestion getSurveyQuestionSample2() {
        return new SurveyQuestion().id(2L).surveyId(2L).text("text2").scaleMin(2).scaleMax(2).orderNo(2);
    }
