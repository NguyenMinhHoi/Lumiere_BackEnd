...
public class AttachmentTestSamples {
    ...
    public static Attachment getAttachmentSample1() {
        return new Attachment().id(1L).name("name1").url("url1").contentType("contentType1").size(1L);
    }

    public static Attachment getAttachmentSample2() {
        return new Attachment().id(2L).name("name2").url("url2").contentType("contentType2").size(2L);
    }
