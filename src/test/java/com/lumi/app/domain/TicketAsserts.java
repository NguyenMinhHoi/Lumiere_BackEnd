...
public class TicketAsserts {
    ...
    public static void assertTicketUpdatableFieldsEquals(Ticket expected, Ticket actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getFirstResponseAt()).as("check firstResponseAt").isEqualTo(expected.getFirstResponseAt()))
            .satisfies(a -> assertThat(a.getResolvedAt()).as("check resolvedAt").isEqualTo(expected.getResolvedAt()))
            .satisfies(a -> assertThat(a.getSlaDueAt()).as("check slaDueAt").isEqualTo(expected.getSlaDueAt()));
    }
