...
public class OrderItemTestSamples {
    ...
    public static OrderItem getOrderItemSample1() {
        return new OrderItem().id(1L).quantity(1L).nameSnapshot("nameSnapshot1").skuSnapshot("skuSnapshot1");
    }

    public static OrderItem getOrderItemSample2() {
        return new OrderItem().id(2L).quantity(2L).nameSnapshot("nameSnapshot2").skuSnapshot("skuSnapshot2");
    }
