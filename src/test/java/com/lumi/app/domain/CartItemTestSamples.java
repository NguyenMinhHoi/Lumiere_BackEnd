...
public class CartItemTestSamples {
    ...
    public static CartItem getCartItemSample1() {
        return new CartItem().id(1L).cartId(1L).productVariantId(1L).quantity(1);
    }

    public static CartItem getCartItemSample2() {
        return new CartItem().id(2L).cartId(2L).productVariantId(2L).quantity(2);
    }

    public static CartItem getCartItemRandomSampleGenerator() {
        return new CartItem()
            .id(longCount.incrementAndGet())
            .cartId(longCount.incrementAndGet())
