...
import com.lumi.app.service.ProductVariantQueryService;
...
/**
 * REST controller for managing {@link com.lumi.app.domain.ProductVariant}.
 */
@RestController
...
public class ProductVariantResource {
    ...
    /**
     * {@code SEARCH  /product-variants/_search?query=:query} : search for the productVariant corresponding
     * to the query.
     *
     ...
     */
    @GetMapping("/_search")
    public ResponseEntity<List<ProductVariantDTO>> searchProductVariants(
