...
/**
 * Criteria class for the {@link com.lumi.app.domain.ClothSupplement} entity. This class is used
 * in {@link com.lumi.app.web.rest.ClothSupplementResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /cloth-supplements?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ClothSupplementCriteria implements Serializable, Criteria {
    ...
    public ClothSupplementCriteria() {}

    public ClothSupplementCriteria(ClothSupplementCriteria other) {
    ...
    @Override
    public ClothSupplementCriteria copy() {
        return new ClothSupplementCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ClothSupplementCriteria that = (ClothSupplementCriteria) o;
        return (
    ...
    public String toString() {
        return "ClothSupplementCriteria{" +
