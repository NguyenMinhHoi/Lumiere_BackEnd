...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "campaign")
...
public class Campaign implements Serializable {
    ...
    public Campaign channel(DeliveryChannel channel) {
    ...
    public Campaign budget(BigDecimal budget) {
    ...
    public Campaign createdAt(Instant createdAt) {
    ...
    public Campaign updatedAt(Instant updatedAt) {
