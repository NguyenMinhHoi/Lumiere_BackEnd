...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLOTHINVENTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CLOTHINVENTORIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLOTHINVENTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLOTHINVENTORY actions', async () => {
      const arg = { id: 863 };
    ...
    it('dispatches UPDATE_CLOTHINVENTORY actions', async () => {
      const arg = { id: 863 };
    ...
    it('dispatches PARTIAL_UPDATE_CLOTHINVENTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLOTHINVENTORY actions', async () => {
      const arg = 42666;
