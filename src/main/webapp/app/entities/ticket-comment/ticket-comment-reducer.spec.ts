...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKETCOMMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_TICKETCOMMENTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TICKETCOMMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TICKETCOMMENT actions', async () => {
      const arg = { id: 17349 };
    ...
    it('dispatches UPDATE_TICKETCOMMENT actions', async () => {
      const arg = { id: 17349 };
    ...
    it('dispatches PARTIAL_UPDATE_TICKETCOMMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TICKETCOMMENT actions', async () => {
      const arg = 42666;
