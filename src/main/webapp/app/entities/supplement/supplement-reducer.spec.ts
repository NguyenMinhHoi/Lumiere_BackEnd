...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPLEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SUPPLEMENTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUPPLEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUPPLEMENT actions', async () => {
      const arg = { id: 22951 };
    ...
    it('dispatches UPDATE_SUPPLEMENT actions', async () => {
      const arg = { id: 22951 };
    ...
    it('dispatches PARTIAL_UPDATE_SUPPLEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUPPLEMENT actions', async () => {
      const arg = 42666;
