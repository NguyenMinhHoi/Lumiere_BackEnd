...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLOTH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CLOTHS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLOTH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLOTH actions', async () => {
      const arg = { id: 19371 };
    ...
    it('dispatches UPDATE_CLOTH actions', async () => {
      const arg = { id: 19371 };
    ...
    it('dispatches PARTIAL_UPDATE_CLOTH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLOTH actions', async () => {
      const arg = 42666;
