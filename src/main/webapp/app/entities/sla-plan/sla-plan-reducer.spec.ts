...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SLAPLAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SLAPLANS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SLAPLAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SLAPLAN actions', async () => {
      const arg = { id: 27971 };
    ...
    it('dispatches UPDATE_SLAPLAN actions', async () => {
      const arg = { id: 27971 };
    ...
    it('dispatches PARTIAL_UPDATE_SLAPLAN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SLAPLAN actions', async () => {
      const arg = 42666;
