...
import { getEntities, searchEntities } from './warehouse.reducer';
  ...
  return (
    <div>
      <h2 id="warehouse-heading" data-cy="WarehouseHeading">
        <Translate contentKey="lumiApp.warehouse.home.title">Warehouses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="lumiApp.warehouse.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/warehouse/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="lumiApp.warehouse.home.createLabel">Create new Warehouse</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('lumiApp.warehouse.home.search')}
                />
        ...
        {warehouseList && warehouseList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="lumiApp.warehouse.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="lumiApp.warehouse.code">Code</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('code')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="lumiApp.warehouse.name">Name</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
            ...
            <tbody>
              {warehouseList.map((warehouse, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{warehouse.createdAt ? <TextFormat type="date" value={warehouse.createdAt} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{warehouse.updatedAt ? <TextFormat type="date" value={warehouse.updatedAt} format={APP_DATE_FORMAT} /> : null}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="lumiApp.warehouse.home.notFound">No Warehouses found</Translate>
            </div>
          )
        )}
      </div>
