...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLOTHAUDIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CLOTHAUDITS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLOTHAUDIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLOTHAUDIT actions', async () => {
      const arg = { id: 15944 };
    ...
    it('dispatches UPDATE_CLOTHAUDIT actions', async () => {
      const arg = { id: 15944 };
    ...
    it('dispatches PARTIAL_UPDATE_CLOTHAUDIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLOTHAUDIT actions', async () => {
      const arg = 42666;
