...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './company-config-additional.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPANYCONFIGADDITIONAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_COMPANYCONFIGADDITIONALS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMPANYCONFIGADDITIONAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMPANYCONFIGADDITIONAL actions', async () => {
      const arg = { id: 27063 };
    ...
    it('dispatches UPDATE_COMPANYCONFIGADDITIONAL actions', async () => {
      const arg = { id: 27063 };
    ...
    it('dispatches PARTIAL_UPDATE_COMPANYCONFIGADDITIONAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMPANYCONFIGADDITIONAL actions', async () => {
      const arg = 42666;
