...
import { getEntities, searchEntities } from './cart-item.reducer';
  ...
  return (
    <div>
      <h2 id="cart-item-heading" data-cy="CartItemHeading">
        <Translate contentKey="lumiApp.cartItem.home.title">Cart Items</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="lumiApp.cartItem.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/cart-item/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="lumiApp.cartItem.home.createLabel">Create new Cart Item</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('lumiApp.cartItem.home.search')}
                />
        ...
        {cartItemList && cartItemList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="lumiApp.cartItem.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('addedAt')}>
                  <Translate contentKey="lumiApp.cartItem.addedAt">Added At</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('addedAt')} />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {cartItemList.map((cartItem, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{cartItem.productVariantId}</td>
                  <td>{cartItem.quantity}</td>
                  <td>{cartItem.addedAt ? <TextFormat type="date" value={cartItem.addedAt} format={APP_DATE_FORMAT} /> : null}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="lumiApp.cartItem.home.notFound">No Cart Items found</Translate>
            </div>
          )
        )}
      </div>
