...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './cloth-stock-movement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLOTHSTOCKMOVEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CLOTHSTOCKMOVEMENTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLOTHSTOCKMOVEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLOTHSTOCKMOVEMENT actions', async () => {
      const arg = { id: 19873 };
    ...
    it('dispatches UPDATE_CLOTHSTOCKMOVEMENT actions', async () => {
      const arg = { id: 19873 };
    ...
    it('dispatches PARTIAL_UPDATE_CLOTHSTOCKMOVEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLOTHSTOCKMOVEMENT actions', async () => {
      const arg = 42666;
