...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SURVEYQUESTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_SURVEYQUESTIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SURVEYQUESTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SURVEYQUESTION actions', async () => {
      const arg = { id: 3563 };
    ...
    it('dispatches UPDATE_SURVEYQUESTION actions', async () => {
      const arg = { id: 3563 };
    ...
    it('dispatches PARTIAL_UPDATE_SURVEYQUESTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SURVEYQUESTION actions', async () => {
      const arg = 42666;
