...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './voucher-redemption.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VOUCHERREDEMPTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_VOUCHERREDEMPTIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VOUCHERREDEMPTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VOUCHERREDEMPTION actions', async () => {
      const arg = { id: 32466 };
    ...
    it('dispatches UPDATE_VOUCHERREDEMPTION actions', async () => {
      const arg = { id: 32466 };
    ...
    it('dispatches PARTIAL_UPDATE_VOUCHERREDEMPTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VOUCHERREDEMPTION actions', async () => {
      const arg = 42666;
