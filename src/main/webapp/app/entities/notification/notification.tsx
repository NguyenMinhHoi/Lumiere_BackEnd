  ...
  return (
    <div>
      <h2 id="notification-heading" data-cy="NotificationHeading">
        <Translate contentKey="lumiApp.notification.home.title">Notifications</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="lumiApp.notification.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/notification/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="lumiApp.notification.home.createLabel">Create new Notification</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('lumiApp.notification.home.search')}
                />
        ...
        {notificationList && notificationList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('lastTriedAt')}>
                  <Translate contentKey="lumiApp.notification.lastTriedAt">Last Tried At</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('lastTriedAt')} />
                </th>
            ...
            <tbody>
              {notificationList.map((notification, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`lumiApp.DeliveryChannel.${notification.channel}`} />
                  </td>
                  <td>{notification.subject}</td>
                  <td>{notification.payload}</td>
                  <td>
                    <Translate contentKey={`lumiApp.SendStatus.${notification.sendStatus}`} />
                  </td>
                  <td>{notification.retryCount}</td>
                  <td>
                    {notification.lastTriedAt ? <TextFormat type="date" value={notification.lastTriedAt} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="lumiApp.notification.home.notFound">No Notifications found</Translate>
            </div>
          )
        )}
      </div>
