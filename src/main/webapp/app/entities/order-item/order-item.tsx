...
import { getEntities, searchEntities } from './order-item.reducer';
  ...
  return (
    <div>
      <h2 id="order-item-heading" data-cy="OrderItemHeading">
        <Translate contentKey="lumiApp.orderItem.home.title">Order Items</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="lumiApp.orderItem.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/order-item/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="lumiApp.orderItem.home.createLabel">Create new Order Item</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('lumiApp.orderItem.home.search')}
                />
        ...
        {orderItemList && orderItemList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('unitPrice')}>
                  <Translate contentKey="lumiApp.orderItem.unitPrice">Unit Price</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('unitPrice')} />
                </th>
                <th className="hand" onClick={sort('totalPrice')}>
                  <Translate contentKey="lumiApp.orderItem.totalPrice">Total Price</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('totalPrice')} />
                </th>
                <th className="hand" onClick={sort('nameSnapshot')}>
                  <Translate contentKey="lumiApp.orderItem.nameSnapshot">Name Snapshot</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('nameSnapshot')} />
                </th>
                <th className="hand" onClick={sort('skuSnapshot')}>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="lumiApp.orderItem.home.notFound">No Order Items found</Translate>
            </div>
          )
        )}
      </div>
