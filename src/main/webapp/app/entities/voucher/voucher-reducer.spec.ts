...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VOUCHER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_VOUCHERS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VOUCHER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VOUCHER actions', async () => {
      const arg = { id: 7837 };
    ...
    it('dispatches UPDATE_VOUCHER actions', async () => {
      const arg = { id: 7837 };
    ...
    it('dispatches PARTIAL_UPDATE_VOUCHER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VOUCHER actions', async () => {
      const arg = 42666;
