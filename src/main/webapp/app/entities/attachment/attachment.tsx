...
import { getEntities, searchEntities } from './attachment.reducer';
  ...
  return (
    <div>
      <h2 id="attachment-heading" data-cy="AttachmentHeading">
        <Translate contentKey="lumiApp.attachment.home.title">Attachments</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="lumiApp.attachment.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/attachment/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="lumiApp.attachment.home.createLabel">Create new Attachment</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('lumiApp.attachment.home.search')}
                />
        ...
        {attachmentList && attachmentList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('url')}>
                  <Translate contentKey="lumiApp.attachment.url">Url</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('url')} />
                </th>
                ...
                <th className="hand" onClick={sort('size')}>
                  <Translate contentKey="lumiApp.attachment.size">Size</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('size')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="lumiApp.attachment.home.notFound">No Attachments found</Translate>
            </div>
          )
        )}
      </div>
