...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './knowledge-article.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KNOWLEDGEARTICLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_KNOWLEDGEARTICLES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KNOWLEDGEARTICLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KNOWLEDGEARTICLE actions', async () => {
      const arg = { id: 11702 };
    ...
    it('dispatches UPDATE_KNOWLEDGEARTICLE actions', async () => {
      const arg = { id: 11702 };
    ...
    it('dispatches PARTIAL_UPDATE_KNOWLEDGEARTICLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KNOWLEDGEARTICLE actions', async () => {
      const arg = 42666;
