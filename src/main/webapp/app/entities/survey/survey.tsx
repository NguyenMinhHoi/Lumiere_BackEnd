...
import { getEntities, searchEntities } from './survey.reducer';
  ...
  return (
    <div>
      <h2 id="survey-heading" data-cy="SurveyHeading">
        <Translate contentKey="lumiApp.survey.home.title">Surveys</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="lumiApp.survey.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/survey/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="lumiApp.survey.home.createLabel">Create new Survey</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('lumiApp.survey.home.search')}
                />
        ...
        {surveyList && surveyList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="lumiApp.survey.title">Title</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('title')} />
                </th>
                ...
                <th className="hand" onClick={sort('dueAt')}>
                  <Translate contentKey="lumiApp.survey.dueAt">Due At</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('dueAt')} />
                </th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/survey/${survey.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/survey/${survey.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="lumiApp.survey.home.notFound">No Surveys found</Translate>
            </div>
          )
        )}
      </div>
      {totalItems ? (
        <div className={surveyList && surveyList.length > 0 ? '' : 'd-none'}>
