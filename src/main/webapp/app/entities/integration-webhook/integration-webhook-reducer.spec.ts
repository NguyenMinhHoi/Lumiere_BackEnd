...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './integration-webhook.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTEGRATIONWEBHOOK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_INTEGRATIONWEBHOOKS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INTEGRATIONWEBHOOK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INTEGRATIONWEBHOOK actions', async () => {
      const arg = { id: 4977 };
    ...
    it('dispatches UPDATE_INTEGRATIONWEBHOOK actions', async () => {
      const arg = { id: 4977 };
    ...
    it('dispatches PARTIAL_UPDATE_INTEGRATIONWEBHOOK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INTEGRATIONWEBHOOK actions', async () => {
      const arg = 42666;
