...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './knowledge-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KNOWLEDGECATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_KNOWLEDGECATEGORIES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KNOWLEDGECATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KNOWLEDGECATEGORY actions', async () => {
      const arg = { id: 25732 };
    ...
    it('dispatches UPDATE_KNOWLEDGECATEGORY actions', async () => {
      const arg = { id: 25732 };
    ...
    it('dispatches PARTIAL_UPDATE_KNOWLEDGECATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KNOWLEDGECATEGORY actions', async () => {
      const arg = 42666;
