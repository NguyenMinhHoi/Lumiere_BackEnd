...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKETTAG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_TICKETTAGS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TICKETTAG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TICKETTAG actions', async () => {
      const arg = { id: 7903 };
    ...
    it('dispatches UPDATE_TICKETTAG actions', async () => {
      const arg = { id: 7903 };
    ...
    it('dispatches PARTIAL_UPDATE_TICKETTAG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TICKETTAG actions', async () => {
      const arg = 42666;
