...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTICLETAG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_ARTICLETAGS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARTICLETAG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARTICLETAG actions', async () => {
      const arg = { id: 25497 };
    ...
    it('dispatches UPDATE_ARTICLETAG actions', async () => {
      const arg = { id: 25497 };
    ...
    it('dispatches PARTIAL_UPDATE_ARTICLETAG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARTICLETAG actions', async () => {
      const arg = 42666;
