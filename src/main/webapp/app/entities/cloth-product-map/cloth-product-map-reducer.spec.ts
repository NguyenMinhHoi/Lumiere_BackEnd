...
import reducer, {
  ...
  searchEntities,
  updateEntity,
} from './cloth-product-map.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLOTHPRODUCTMAP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CLOTHPRODUCTMAPS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLOTHPRODUCTMAP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLOTHPRODUCTMAP actions', async () => {
      const arg = { id: 663 };
    ...
    it('dispatches UPDATE_CLOTHPRODUCTMAP actions', async () => {
      const arg = { id: 663 };
    ...
    it('dispatches PARTIAL_UPDATE_CLOTHPRODUCTMAP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLOTHPRODUCTMAP actions', async () => {
      const arg = 42666;
