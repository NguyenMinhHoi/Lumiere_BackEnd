...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLOTHSUPPLEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CLOTHSUPPLEMENTS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLOTHSUPPLEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLOTHSUPPLEMENT actions', async () => {
      const arg = { id: 2916 };
    ...
    it('dispatches UPDATE_CLOTHSUPPLEMENT actions', async () => {
      const arg = { id: 2916 };
    ...
    it('dispatches PARTIAL_UPDATE_CLOTHSUPPLEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLOTHSUPPLEMENT actions', async () => {
      const arg = 42666;
